...
basepath <- "/Users/helenacoggan/mnt/chip-lacava-e2//Groups/BCH-ED/"
...
#     ),
#     is_weekend = ifelse(day_of_week_of_arrival==1 | day_of_week_of_arrival==7, 1, 0), #Sunday is 1, Saturday is 7
...
#Mark unknown values (except for pain, categorised separately); DO NOT IMPUTE RAW VITALS.
all_vitals <- colnames(visits)[grepl("overall|triage", colnames(visits)) & !grepl("pain", colnames(visits)) & !grepl("raw", colnames(visits))]
